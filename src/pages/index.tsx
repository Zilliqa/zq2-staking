...
//import Logo from "../assets/svgs/logo-desktop.svg"
import SmallLogo from "../assets/svgs/logo-mobile.svg"
...
const [selectedPoolType, setSelectedPoolType] = useState(
  ...
  return (
    ...
    onClick={() => router.push({ query: {} }, undefined, { shallow: true })}
  />
        ...
        <div className="grow relative mx-auto overflow-y-hidden max-w-screen-4k w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 4k:gap-14 h-full max-lg:pb-16">
            ...
            >
              <StakingPoolsList selectedPoolType={selectedPoolType} setSelectedPoolType={setSelectedPoolType} setViewClaim={setViewClaim} />
            </div>
