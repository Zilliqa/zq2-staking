  ...
  [CHAIN_ZQ2_PROTOMAINNET.id]: [
    ...
    },
    {
      definition: {
        ...
        name: "TorchWallet.io",
        description: "By using Torch, you stay eligible for potential airdrops & rewards in the Zilliqa ecosystem. "
          + "Torch is the most advanced and widely used mobile and desktop wallet for Zilliqa, offering a smooth "
          + "experience for staking, instant unstaking, DEX swapping, and full support for both Legacy & EVM accounts. "
          + "If you stake here on the portal, it will automatically appear in the app. Try it out now! "
